...
int main()
{
    ...
    while (true) {
        cout << "Wybierz jedna z opcji ponizej";
        cout << "\n\t1-->Dodaj nowe konto";
        cout << "\n\t2-->Pokaz wszystkie konta";
        cout << "\n\t3-->Szukaj informacji";
        cout << "\n\t4-->Zmien informacje";
        cout << "\n\t5-->Usun informacje";
        cout << "\n\t6-->Wyjscie";
        cout << "\nTwój wybor:"; cin >> wybor;
...
void konto_info::search_reg()
{
    ...
    cout << endl << "Jest " << ilosc_wpisow << " wpisow w pliku" << endl;
    cout << "Podaj numer wpisu, który chcesz wyszukac: "; cin >> nr_wpisu;
...
void konto_info::edit_reg()
{
    ...
    cout << endl << "Podaj numer wpisu, który chcesz wyszukaa: "; cin >> nr_wpisu;
    ...
    cout << endl << "Podaj wpis, który chcesz zmodyfikowaa: "; cin >> nr_wpisu;
    read_data();
...
void konto_info::del_reg()
{
    ...
    cout << endl << "Jest " << ilosc_wpisow << " wpisów w pliku" << endl;
    cout << "Podaj numer wpisu, który chcesz usunac: "; cin >> nr_wpisu;
